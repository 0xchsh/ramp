...
// Inlined so the fill follows `color` (currentColor) at capture time —
// using <img> + CSS `filter: invert(1)` worked on screen but html2canvas
// silently dropped the filter, so the saved PNG kept the original black.
export function RampLogo({ height = 14, color, opacity = 1, style }: Props) {
  return (
    <svg
